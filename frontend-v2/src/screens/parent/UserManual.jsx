...
const TOPICS = [
  ...
  { i: ShieldCheck, a: '#06b6d4', q: 'How does the Security PIN work?', t: 'A 6-digit Security PIN protects sensitive actions: deleting the account, removing a child, disabling monitoring, or changing security settings. Change it anytime, or recover it via email verification.' },
