  ...
  return (
    <div className="relative min-h-screen w-full bg-[#030307] overflow-hidden flex items-center justify-center px-4 py-8 font-sans">
      ...
      <motion.div 
        ...
        className="relative z-10 w-full max-w-[430px] px-6 py-10 bg-white/5 border border-white/5 rounded-3xl shadow-[0_24px_60px_rgba(0,0,0,0.6)] backdrop-blur-xl flex flex-col"
      >
