...
const Reports = () => {
  ...
  const handleDownload = () => {
    ...
    const lines = [
      '═══════════════════════════════════════════════════════',
      '        CHILDSHIELD AI — PARENTAL INSIGHTS REPORT',
      '═══════════════════════════════════════════════════════',
      ...
      '',
      '═══════════════════════════════════════════════════════',
      '  This report was generated by ChildShield AI.',
    ...
    a.href = url;
    a.download = `ChildShield-Report-${activeChild?.name || 'child'}-${new Date().toISOString().split('T')[0]}.txt`;
    a.click();
